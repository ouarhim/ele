...
export default async function InstallationsImmeublesPage({ params }: { params: Promise<{ locale: string }> }) {
  const { locale } = await params;
  const t = await getTranslations({ locale, namespace: 'InstallationsImmeubles' });
  ...
  return (
    <main className="container mx-auto px-4 py-12" suppressHydrationWarning>
      ...
      <section className="mb-16">
        ...
        <div className="row">
          <ProcessStep 
            title={t('Process.etude.title')} 
            description={t('Process.etude.description')} 
            step="1"
          />
          <ProcessStep 
            title={t('Process.schemas.title')} 
            description={t('Process.schemas.description')} 
            step="2"
          />
          <ProcessStep 
            title={t('Process.cablage.title')} 
            description={t('Process.cablage.description')} 
            step="3"
          />
          <ProcessStep 
            title={t('Process.essais.title')} 
            description={t('Process.essais.description')} 
            step="4"
          />
        </div>
      </section>
      ...
      <section className="mb-16 bg-light py-12 rounded-lg">
        ...
        <div className="row">
          <ServiceCard 
            title={t('Services.colonnes.title')} 
            description={t('Services.colonnes.description')} 
            icon="bi-building"
          />
          <ServiceCard 
            title={t('Services.gtl.title')} 
            description={t('Services.gtl.description')} 
            icon="bi-box"
          />
          <ServiceCard 
            title={t('Services.eclairage.title')} 
            description={t('Services.eclairage.description')} 
            icon="bi-lightbulb"
          />
          <ServiceCard 
            title={t('Services.parafoudre.title')} 
            description={t('Services.parafoudre.description')} 
            icon="bi-lightning"
          />
        </div>
      </section>
      ...
      <section className="mb-16">
        ...
        <div className="row">
          ...
          />
          <BenefitCard 
            title={t('Benefits.extensions.title')} 
            description={t('Benefits.extensions.description')} 
            icon="bi-arrow-right"
          />
        </div>
      </section>
      ...
      <section className="mb-16">
        ...
        <div className="row">
          <PricingCard 
            title={t('Pricing.petit.title')} 
            description={t('Pricing.petit.description')} 
            price={t('Pricing.petit.price')} 
            duration={t('Pricing.petit.duration')}
          />
          <PricingCard 
            title={t('Pricing.grand.title')} 
            description={t('Pricing.grand.description')} 
            price={t('Pricing.grand.price')} 
            duration={t('Pricing.grand.duration')}
          />
          <PricingCard 
            title={t('Pricing.renovation.title')} 
            description={t('Pricing.renovation.description')} 
            price={t('Pricing.renovation.price')} 
            duration={t('Pricing.renovation.duration')}
          />
        </div>
      </section>
      ...
      <section className="mb-16">
        ...
        <div className="row">
          ...
          />
          <PreparationCard 
            title={t('Preparation.puissances.title')} 
            description={t('Preparation.puissances.description')} 
            icon="bi-lightning"
          />
          <PreparationCard 
            title={t('Preparation.reglement.title')} 
            description={t('Preparation.reglement.description')} 
            icon="bi-file-text"
          />
          <PreparationCard 
